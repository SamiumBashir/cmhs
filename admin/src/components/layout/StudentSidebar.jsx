...
import { FiUser, FiFileText, FiCalendar, FiBarChart2, FiBell, FiClipboard } from 'react-icons/fi'
import { NavLink } from 'react-router-dom'
import { motion, AnimatePresence } from 'framer-motion'

const navItems = [
  { path: '/student', label: 'Dashboard', icon: <FiBarChart2 size={20} /> },
  { path: '/student/profile', label: 'Profile', icon: <FiUser size={20} /> },
  { path: '/student/routine', label: 'Routine', icon: <FiCalendar size={20} /> },
  { path: '/student/attendance', label: 'Attendance', icon: <FiClipboard size={20} /> },
  { path: '/student/results', label: 'Results', icon: <FiFileText size={20} /> },
  { path: '/student/fees', label: 'Fees', icon: <FiBarChart2 size={20} /> },
  { path: '/student/notices', label: 'Notices', icon: <FiBell size={20} /> }
]
